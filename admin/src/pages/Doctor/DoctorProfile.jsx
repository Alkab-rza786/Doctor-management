    ...
    <div>
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white ' >
          ...
          <p className='flex items-center gap2 text-3xl font-medium text-gray-700'>{profileData.name}</p>
          ...
          <div className='flex gap-1 pt-2'>
            <input onChange={() => isEdit && setProfileData(prev => ({ ...prev, availabel: !prev.availabel }))} checked={profileData.availabel} type="checkbox" />
