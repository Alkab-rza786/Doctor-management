...
function Myprofile() {
  ...
  const [userData, setUserData] = useState({
    ...
    email: "alkabrza@gamil.com",
    phone: "8102848501",
    address: {
      line1: "Bari Bajar, Niche Tola",
      line2: "Chaibasa W singbhum, Jharkhand"
    },
    gender: 'Male',
    dob: '2002-06-08'
  })
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdite ?
              <input className='bg-gray-100 max-w-52' type="text" value={userData.phone} onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} /> : <p className='text-blue-400'>{userData.phone}</p>
          }
